...
public class ObjectFactory {
    ...
    private final static QName _EliminarUsuarioResponse_QNAME = new QName("http://interfaces/", "eliminarUsuarioResponse");
    ...
    private final static QName _DownloadImage_QNAME = new QName("http://interfaces/", "downloadImage");
    ...
    private final static QName _EliminarUsuario_QNAME = new QName("http://interfaces/", "eliminarUsuario");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces/", name = "eliminarUsuarioResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces/", name = "downloadImage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces/", name = "uploadImageResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces/", name = "downloadImageResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://interfaces/", name = "eliminarUsuario")
