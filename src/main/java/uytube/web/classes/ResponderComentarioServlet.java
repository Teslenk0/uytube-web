...
public class ResponderComentarioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        /*System.out.println("El padre es: "+padre);
        System.out.println("El comentario a responder es: "+com);*/
        ...
        if(!comentario.isEmpty()){
            DtComentario c = new DtComentario(user.getNickname(),comentario, fecha, v, padre, ref, canal.getNombre_canal());
